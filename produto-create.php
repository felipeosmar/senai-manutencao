...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO produto (prod_nome,prod_preco,prod_categ,prod_estab_id,prod_estab_datareg,prod_ultimaalt) VALUES (?,?,?,?,?,?)");

        if($stmt->execute([ $prod_nome,$prod_preco,$prod_categ,$prod_estab_id,$prod_estab_datareg,$prod_ultimaalt  ])) {
                $stmt = null;
